            ...
            <div className="row justify-content-evenly">
              <div className="col">
                <ul className="social-links list-unstyled d-flex m-0">
                  <li className="pe-2">
                    <a href="https://www.facebook.com" target="_blank" className="border-0">
                      <FaFacebook style={{ width: '20px', height: '20px', color: 'blue' }} />
                    </a>
                  </li>
                  <li className="pe-2">
                    <a href="https://www.instagram.com" target="_blank" className="border-0">
                      <FaInstagram style={{ width: '20px', height: '20px', color: 'pink' }} />
                    </a>
                  </li>
                  <li className="pe-2">
                    <a href="https://www.youtube.com" target="_blank" className="border-0">
